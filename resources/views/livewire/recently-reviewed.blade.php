        ...
        <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
            <div class="relative flex-none">
                ...
                @if (isset($game['rating']))
                    <div id="reviews_{{$game['slug']}}" class="absolute bottom-0 right-0 w-16 h-16 bg-gray-900 rounded-full" style="right: -20px; bottom:-20px;">
    ...
    @empty
        @foreach (range(1,3) as $game)
            <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                ...
                <div class="ml-12">
                    <div class="inline-block text-lg font-semibold leading-tight mt-4 text-transparent bg-gray-700 rounded">
                        title here
                    </div>
